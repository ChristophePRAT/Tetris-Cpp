...
file_name = "../scores/3/scores_gennn_2.csv"
...
plt.plot(new_df["population"] * 20, new_df["best_score"], label="Best" + metric)
plt.plot(new_df["population"] * 20, new_df["mean"], label="Mean")
plt.plot(new_df["population"] * 20, new_df["median"], label="Median")
plt.plot(new_df["population"] * 20, new_df["worst_score"], label="Worst" + metric)
